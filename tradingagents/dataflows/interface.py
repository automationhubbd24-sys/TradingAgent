...
from .binance import (
    ...
    get_binance_futures_indicators_window,
...
VENDOR_METHODS = {
    ...
    "get_stock_data": {
        ...
        "binance_spot": get_binance_spot_data,
        "binance_futures": get_binance_futures_data,
    },
    # technical_indicators
    "get_indicators": {
        "alpha_vantage": get_alpha_vantage_indicator,
        "yfinance": get_stock_stats_indicators_window,
        "binance_spot": get_binance_spot_indicators_window,
        "binance_futures": get_binance_futures_indicators_window,
    },
    # fundamental_data
    "get_fundamentals": {
